...
/// Exception thrown when a json document (Entry) is missing a key attribute which is needed in the (f)ml40 structure.
class JsonMissingKeyException extends InvalidJsonSchemaException {
  ...
  @override
  String toString() {
    return "JsonMissingKeyException: Missing key: $errorMessage | Try parsing: $jsonDump";
  }
}
